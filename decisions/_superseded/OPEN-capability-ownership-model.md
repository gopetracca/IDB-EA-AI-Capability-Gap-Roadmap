# OPEN — How to record who owns a capability

**Status: OPEN. Not decided.** Raised 4 September 2026. Decision owner: Gabriel Petracca (EA).
If taken, this becomes D11 in `decisions/meta-model-decisions.md`.
