...
**Inter-American Development Bank** · generated 2026-09-04 · scale `level`
...
| `1.5` | AI Ecosystem & Alliance Management | **none** | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| `2.3` | AI Product Management | **none** | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `2.4` | Business Process & Service Redesign | Digital Transformation | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| `2.6` | AI Innovation & Incubation | Emerging Tech | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| ID | Capability | Owner | Pra | Ena | Ski | Def | Level | Why |
|---|---|---|:-:|:-:|:-:|:-:|:-:|---|
| `3.1` | Data Governance & Stewardship for AI | Data Management | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `3.2` | Data Sourcing, Licensing & Provenance | Data Management | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `3.3` | Data Quality & Preparation for AI | Data Management | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `3.4` | Metadata, Lineage & Cataloging for AI | Data Management | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| `3.7` | Derived Representation Management | Artificial Intelligence | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| `4.2` | Model Selection, Customization & Tuning | Artificial Intelligence | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `4.3` | Prompt & Context Engineering | Artificial Intelligence | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| `4.6` | AI Evaluation & Testing | **none** | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| ID | Capability | Owner | Pra | Ena | Ski | Def | Level | Why |
|---|---|---|:-:|:-:|:-:|:-:|:-:|---|
| `6.1` | AI Deployment & Serving Operations | Artificial Intelligence | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `6.2` | AI Monitoring & Observability | Cloud and Infrastructure | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `6.3` | Continuous Evaluation, Drift & Quality Management | **none** | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `6.4` | AI Incident & Problem Management | Service Delivery | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `6.5` | AI Cost Management | Cloud and Infrastructure | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| ID | Capability | Owner | Pra | Ena | Ski | Def | Level | Why |
|---|---|---|:-:|:-:|:-:|:-:|:-:|---|
| `7.1` | AI Policy, Standards & Management System | Artificial Intelligence | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `7.2` | Responsible & Trustworthy AI Practice | **none** | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
...
| `7.4` | AI Security & Resilience | Cybersecurity | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `7.5` | Privacy & Data Protection for AI | **none** | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `7.6` | Legal, Regulatory & Contractual Compliance for AI | **none** | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `7.7` | AI System & Agent Inventory Management | Artificial Intelligence | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
| `7.8` | AI Assurance & Evidence Management | IT Risk (Compliance) | ? | no | ? | ? | *not rated* | Not rated: performance has never been observed (enabled recorded, which cannot place a level on its own) |
