...
| `5.8` | AI Agent Runtime & Execution Environment | Artificial Intelligence | ? | part | ? | part | *not rated* | Not rated: the practice has never been observed (enabled, defined recorded, which describes the enablers, not the practice) |
