...
**Inter-American Development Bank** · generated 2026-09-10 · scale `maturity` · **a lens, not the assessment**
...
| ID | Capability | Owner | Pra | Ena | Ski | Def | Level | Why |
|---|---|---|:-:|:-:|:-:|:-:|:-:|---|
| `4.1` | AI Architecture Management & Solution Governance | Enterprise Architecture | part | yes | ? | yes | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
| `4.2` | Model Selection, Customization & Tuning | Artificial Intelligence | part | part | ? | no | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
...
| `4.4` | Agent & Workflow Orchestration Design | Enterprise Architecture | part | n-a | ? | part | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
| `4.5` | Integration & Tool Enablement | Core Platforms | part | part | ? | yes | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
| `4.6` | AI Evaluation & Testing | Artificial Intelligence | part | no | ? | no | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
| `4.7` | AI Release & Change Management | Core Platforms | part | part | ? | yes | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
...
| `5.2` | Model Access & Traffic Management | Artificial Intelligence | part | yes | ? | yes | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
| `5.3` | AI Environment & Workspace Management | Core Platforms | yes | yes | ? | yes | **1** Initial | Done consistently, but nothing yet carries it beyond the people doing it: competence is not evidenced |
| `5.4` | AI Compute & Capacity Management | Cloud and Infrastructure | ? | yes | ? | n-a | *not rated* | Not rated: the practice has never been observed (enabled, defined recorded, which describes the enablers, not the practice) |
| `5.5` | Tool & Connector Catalog Management | **none** | ? | no | ? | ? | *not rated* | Not rated: the practice has never been observed (enabled recorded, which describes the enablers, not the practice) |
| `5.6` | AI Developer Experience & Reuse Assets | Core Platforms | part | part | ? | ? | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
| `5.7` | AI Runtime Mediation & Egress Control | Artificial Intelligence | ? | ? | ? | ? | *not rated* | Not rated: the practice has never been observed |
| `5.8` | AI Agent Runtime & Execution Environment | Artificial Intelligence | part | yes | ? | part | **1** Initial | Done where individuals or teams make it happen, not consistently across the Bank |
| `5.9` | AI Experimentation | Emerging Tech | ? | ? | ? | ? | *not rated* | Not rated: the practice has never been observed |
...
| `6.7` | Human Oversight Operations | **none** | ? | ? | ? | ? | *not rated* | Not rated: the practice has never been observed |
