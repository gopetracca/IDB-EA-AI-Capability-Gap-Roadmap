...
| `4.2` | Model Selection, Customization & Tuning | Artificial Intelligence | ? | ? | ? | ? | *not rated* | Not rated: nothing has been observed |
| `4.3` | Prompt & Context Engineering | Artificial Intelligence | ? | ? | ? | ? | *not rated* | Not rated: nothing has been observed |
...
| `4.6` | AI Evaluation & Testing | **none** | ? | ? | ? | ? | *not rated* | Not rated: nothing has been observed |
...
| `5.8` | AI Agent Runtime & Execution Environment | Artificial Intelligence | ? | part | ? | part | **3** Stabilizing | 1 of 2 observed dimensions achieved; practised, skilled not observed |
